...
StopServer <- function() {
    invisible(.Call('MagmaSolve_StopServer', PACKAGE = 'MagmaSolve'))
}
...
.CleanupSharedMemory <- function() {
    .Call('MagmaSolve_CleanupSharedMemory', PACKAGE = 'MagmaSolve')
}
...
GetServerArgs <- function(matrixDimension, withVectors, numGPUsWanted, memName, semName, printDetails) {
    .Call('MagmaSolve_GetServerArgs', PACKAGE = 'MagmaSolve', matrixDimension, withVectors, numGPUsWanted, memName, semName, printDetails)
}
...
solve_mgpu <- function(matrix, symmetric = TRUE, only_values = FALSE, overwrite = FALSE, printInfo = FALSE){
    .Call('MagmaSolve_solve_mgpu', PACKAGE = 'MagmaSolve',  matrix, symmetric, only_values, overwrite, printInfo)
}
